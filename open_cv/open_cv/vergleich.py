...
class ImageSubscriber(Node):
    ...
    #     dst2 = cv2.pyrDown(current_frame)  #轮廓加粗!!!
        canny = cv2.Canny(current_frame, 150, 400)
        # p2 = cv2.dilate(canny,kernel)

        #找轮廓的点，拟合圆

    #     circles = cv2.HoughCircles(  # kleiner keris in 1.py
    #     current_frame, cv2.HOUGH_GRADIENT, 1, 50, param1=400, param2=15, minRadius=15, maxRadius=100)
    #     print(circles)
    #     print('---------------------------')
    ...
    #         cv2.circle(col, (x, y), 5, (0, 0, 255), -1)
        ...
        # ZeroDivisionError: float division by zero
                ...
                cv2.circle(col, (cX, cY), 1, (0, 0, 255), 1)
