...
{
  new (message_memory) interface::msg::Led(_init);
}

void Led_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface::msg::Led *>(message_memory);
  typed_message->~Led();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Led_message_member_array[3] = {
  {
    ...
    offsetof(interface::msg::Led, led_1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::msg::Led, led_2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::msg::Led, led_3),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::interface::msg::rosidl_typesupport_introspection_cpp::Led_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, msg, Led)() {
  return &::interface::msg::rosidl_typesupport_introspection_cpp::Led_message_type_support_handle;
}
